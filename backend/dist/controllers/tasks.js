    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          _context3.next = 5;
          return connection.execute("SELECT * FROM tasks WHERE id = ?", [req.params.id]);
        case 5:
          rows = _context3.sent;
          res.json(rows[0][0]);
        case 7:
...
var getTasksCount = exports.getTasksCount = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var connection, _yield$connection$exe5, _yield$connection$exe6, rows;
  ...
  return function getTasksCount(_x11, _x12) {
